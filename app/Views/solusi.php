            ...
            <div class="row gap-2 mt-4 d-flex flex-wrap justify-content-center">
                <?php foreach ($solusi as $key => $value) { ?>
                    <div class="card shadow p-2"
                        style="background-color: white ; border-radius: 10px; width: 270px;">
        ...
        <div class="col-10 p-4">
            ...
            <div class="container p-2">
                <div class="tabs d-flex justify-content-center">
                    <div class="col-3 shadow tablink rounded" onclick="bukaTab(event, 'tab1')"
                        style="height: auto; background-color: white; border: 0.5px #03c988 solid;">
                        <div class="col-12 text-center pt-2">
                            <h6 class="fw-bold">Klinik</h6>
                        </div>
                    </div>
                    <div class="col-3 shadow tablink rounded" onclick="bukaTab(event, 'tab2')"
                        style="height: auto; background-color: white; border: 0.5px #03c988 solid;">
                        <div class="col-12 text-center pt-2">
                            <h6 class="fw-bold">Rumah sakit</h6>
                        </div>
                    </div>
                    <div class="col-3 shadow tablink rounded" onclick="bukaTab(event, 'tab3')"
                        style="height: auto; background-color: white; border:0.51px #03c988 solid;">
                        <div class="col-12 text-center pt-2">
