...
<div class="container">
        ...
        <div class="carousel-indicators">
            <?php foreach ($banner as $key => $value) { ?>
                <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="<?= $key ?>" <?php if ($key === 0)
                      echo 'class="active"'; ?> aria-label="Slide <?= $key + 1 ?>"></button>
            <?php } ?>
        </div>
        ...
        <div class="col-12" style="margin-top: 50px; height: auto; ">
            <div class="col-12 p-5">
                <div class="col-12 text-center">
                    <p class="mb-lg-1" style="font-size: 40px; font-weight: 500;"><?= $headsolusi[0]['judul_solusi'] ?>
                    </p>
                ...
                <div class="col-12 md-4 d-flex gap-2 flex-wrap justify-content-center mt-4">
                    ...
                    foreach ($solusi_sliced as $key => $value) {
                        ?>
                        <div class="card shadow border-none p-2"
                            style="background-color: white ; border-radius: 10px; width: 300px;">
    ...
    <br>
    <div class="col-12 text-center">
        <h2 class="mb-lg-3 mt-4"><?= $headartikel[0]['judul_artikel'] ?>
        </h2>
