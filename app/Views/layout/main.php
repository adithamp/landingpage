    ...
    <div class="col-12 mt-4 border">
        <div class="card" style="background-color: white;">
            ...
            <div class="footer col-12 d-flex flex-column align-items-center pt-3" style="height: auto;">
                <p class="txt p-0 m-0 text-light fw-bold" style="font-size: 15.5px;"><?= $footer[0]['nama'] ?></p>
                <p class="txt p-0 m-0 text-light pb-2" style="font-size: 15.5px;"><?= $footer[0]['hak_cipta'] ?></p>
            </div>
        </div>
    </div>
